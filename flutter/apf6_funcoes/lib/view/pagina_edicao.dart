...
class EditPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Object? arguments =
            ...
            Pessoa pessoa = arguments as Pessoa;

    return ChangeNotifierProvider(
      create: (_) => EstadoListaDePessoas(pessoa: pessoa),
      child: Scaffold(
...
class DropdownButton extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var state = Provider.of<EstadoListaDePessoas>(context, listen: false);
    return Container(
